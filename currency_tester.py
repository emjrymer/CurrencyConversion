import unittest
from conversion_functions import convert_usd_to_eur, convert_eur_to_usd, convert_multi_entries_eur_to_usd, convert_multi_entries_usd_to_eur, register_usd_to_eur, register_eur_to_usd, valid_input
...
class EurToUsdTestCase(unittest.TestCase):
    ...
    def test_rgister_eur_to_usd(self):
